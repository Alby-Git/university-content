...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Es wird erwartet, dass Grundraum bei Stochastischen Experimenten angegeben wird.
    \[
      A = \{ \omega = \{\omega_1, \omega_2, \omega_3, \omega_4 \} | \omega_1 > \omega_2 > \omega_3 > \omega_4 \}  
    \]
\end{enumerate}
\section*{Aufgabe 2}
